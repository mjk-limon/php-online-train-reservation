		...
		<div class="maintext">
			<div id="flights" class="allfromgroove">
				<form action="code/showscheduleCode.php" method="post">
					...
					<div class="all-infut">
						<label class="ftext">Bus Type</label>
					...
					<div class="all-infut">
						<label id="label0" class="ftext">Total Seat:</label>
						<input required="" type="text" name="seat" placeholder="Total Seat" value="40" />
					</div>				
					<div class="all-infut">
						<label class="ftext">Seat Cost:</label>
						<input required="" type="text" name="scost" placeholder="Seat cost" maxlength="20" />
					</div>
