...
<div id="twoWay">
  <!-- Code for two way -->
          <form action="searchFlightAdmin.php" method="get">
            <div></br>
...
<!-- Fetching  return Location -->
          ...
          <p class="ftext" id="dateIn"></p>
            <input  class="search"  style="background-color: #34495e" type="submit" name="searchTwo" id="find" value="Search Trains"/>
            </form>
</div>

<!-- Code for One way -->
          <form id="oneWay" action="searchFlightAdmin.php" method="get">
            <div></br>
...
<!-- Fetching  return Location -->
            ...
            <input required="" class="search"  style="background-color: #34495e" type="submit" name="searchOne" id="find" value="Search Buses"/>
            </form>
</body>
