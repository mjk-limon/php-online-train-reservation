...
<!-- Code for trip submission -->
      ...
      <div id="flights" style="font-family:Courier; font-size: 15px; border-style: groove;">
        <h1 style="color: white" class="ftext">Select Your Trip Type</h1>
...
<!-- Fetching  return Location -->
            ...
            <p><label style="color: white" style="display: solid block" id="label0" class="ftext">Depart date:</label>
            <input required="" type="text" name="depart_date" id="datepicker1"  placeholder="month/day/year" /></p>
            <p><label style="color: white" style="display:solid block" id="label1" class="ftext" >Return date:</label>
            <input required="" type="text" name="return_date" id="datepicker" placeholder="month/day/year" /></p>
          </br>
          <p class="ftext" id="dateIn"></p>
            <input  class="search"  style="background-color: #34495e" type="submit" name="searchTwo" id="find" value="Search Buses/Trains"/>
            </form>
</div>

<!-- Code for One way -->
          <form id="oneWay" action="info.php" method="get">
            <div></br>
...
<!-- Fetching  return Location -->
            ...
            <p><label style="color: white" style="display: solid block" id="label0" class="ftext">Date:</label>
            <input required="" type="text" id="datepicker3" name="depart_date"  placeholder="month/day/year" /></p>
          </br>
            <input required="" class="search"  style="background-color: #34495e" type="submit" name="searchOne" id="find" value="Search Buses/Train"/>
            </form>
</body>
